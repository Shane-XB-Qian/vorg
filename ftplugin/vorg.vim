...
nnoremap <buffer> -- mp0t]:if search(']', 'Wnc', getline('.'))<bar>:if strpart(getline("."), col(".")-1, 1, v:true)==#'x'<bar>:exe 'normal! r '<bar>:else<bar>:exe 'normal! rx'<bar>:endif<bar>:endif<cr>`p
